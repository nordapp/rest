...
public interface IConfNode
{
	...
	/**
	 * Searches a node by a given path
	 * 
	 * @param path The path
	 * @return The node or null if the node doesn't exists
	 */
	IConfNode get(String path);
	
	/**
	 * @param name The name of the child node
	 * @return The child node or null if the child node doesn't exists
	 */
	IConfNode child(String name);
	 ...
	 */
	Iterator<String> getChildNodeNames(); // Iterator Ueber Node-Namen !
	
	/**
	 * @return The child nodes iterator
	 */
	Iterator<IConfNode> getChildNodes();
	
	/**
	 * @return The child nodes as an array
	 */
	IConfNode[] getChildArray();
