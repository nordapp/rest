 ...
 *
 */
public class KeyValueRuleInclude extends AbstractKeyValueRule {
	
	private static final Logger logger = LoggerFactory.getLogger(KeyValueRuleInclude.class);
	...
	private List<AbstractReader> inputList;
	private String prefix;

	public KeyValueRuleInclude(List<AbstractReader> inputList) {
		super();
