...
public class ConfNode implements IConfNode, Serializable
{
	 ...
	 */
	public IConfNode child(String cname)
	{
	 ...
	 */
	public IConfNode get(String path)
	{
		int depth = 0;
		String[] pathElems = null;
		IConfNode rt = root();
	 ...
	 */
	public void remove(IConfNode node)
	{
	...
	/* (non-Javadoc)
	 * @see com.i3xx.util.ctree.IConfNode#getChildNodeNames()
	 */
	...
	/* (non-Javadoc)
	 * @see com.i3xx.util.ctree.IConfNode#getChildNodesArray()
	 */
	public synchronized IConfNode[] getChildArray()
	{
