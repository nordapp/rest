...
import com.i3xx.util.core.ConvertStringTokenizer;
import com.i3xx.util.core.StreamSource;
...
import com.i3xx.util.ctree.IParser;
	...
	public static String convert(String value) throws IOException
	{
		...
		while(tok.hasNextToken()){
			...
			if(tok.tokenIsText()){
				...
				buf.append(com.i3xx.util.ctree.ConfParser.CHAR_X_5B + tmp + 
						com.i3xx.util.ctree.ConfParser.CHAR_X_5D);
			}
		}
		return buf.toString();
	}
